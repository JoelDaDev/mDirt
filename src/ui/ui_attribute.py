...
################################################################################
## Form generated from reading UI file 'attributeYzZxCD.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.attributeRemove, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.amountOperationBox, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.amountSpinBox, 2, 1, 1, 1)
